...
namespace Jde::Markets
{
	struct JDE_MARKETS_EXPORT WrapperLog : public EWrapper //TODO refactor upgrade to latest tws.
	{
		...
		void bondContractDetails( int reqId, const ibapi::ContractDetails& contractDetails)noexcept  override;
		...
		void scannerData(int reqId, int rank, const ibapi::ContractDetails& contractDetails, const std::string& distance, const std::string& benchmark, const std::string& projection,	const std::string& legsStr)noexcept override;
		...
		void deltaNeutralValidation(int reqId, const ibapi::DeltaNeutralContract& deltaNeutralContract)noexcept override;
		...
		void symbolSamples(int reqId, const std::vector<ibapi::ContractDescription> &contractDescriptions)noexcept override;
		...
		void historicalDataUpdate(TickerId reqId, const ibapi::Bar& bar)noexcept override;
