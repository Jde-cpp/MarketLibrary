...
namespace Jde::Markets
{
	...
	void WrapperLog::error( int id, int errorCode, const std::string& errorMsg )noexcept
	{
		if( _historicalDataRequests.erase(id) )
			LOG( _logLevel, "({})_historicalDataRequests.erase(){}", id, _historicalDataRequests.size() );
...
#pragma endregion
	...
	void WrapperLog::tickByTickAllLast(int reqId, int tickType, time_t time, double price, long long /*size*/, const TickAttribLast& /*attribs*/, const std::string& /*exchange*/, const std::string& /*specialConditions*/)noexcept{ LOG( _logLevel, "WrapperLog::tickByTickAllLast( {}, {}, {}, {} )", reqId, tickType, time, price);  }
	...
	void WrapperLog::updateMktDepthL2(TickerId id, int position, const std::string& marketMaker, int operation, int /*side*/, double /*price*/, long long /*size*/, bool isSmartDepth)noexcept{ LOG( _logLevel, "WrapperLog::updateMktDepthL2( {}, {}, {}, {}, {} )", id, position, marketMaker, operation, isSmartDepth); }
	...
	void WrapperLog::scannerData(int reqId, int rank, const ::ContractDetails& contractDetails, const std::string& distance, const std::string& /*benchmark*/, const std::string& /*projection*/, const std::string& /*legsStr*/)noexcept{ LOG( _logLevel, "WrapperLog::scannerData( {}, {}, {}, {} )", reqId, rank, contractDetails.contract.conId, distance ); }
...
#pragma region Poision
	void WrapperLog::position( const std::string& account, const ::Contract& contract, double position, double avgCost )noexcept{ LOG( _logLevel, "WrapperLog::position( {}, {}, {}, {}, {} )", account, contract.conId, contract.symbol, position, avgCost ); }
...
#pragma endregion
	...
	void WrapperLog::positionMulti( int reqId, const std::string& account,const std::string& modelCode, const ::Contract& contract, double /*pos*/, double /*avgCost*/)noexcept{ LOG( _logLevel, "WrapperLog::positionMulti( {}, {}, {}, {} )", reqId, account, modelCode, contract.conId); }
