...
namespace Jde::Markets
{
	...
	struct JDE_MARKETS_EXPORT WrapperCache : public WrapperLog
	{
		...
		static Proto::Results::ExchangeContracts ToOptionParam( string_view exchange, int underlyingConId, const std::string& tradingClass, const std::string& multiplier, const std::set<std::string>& expirations, const std::set<double>& strikes )noexcept;
